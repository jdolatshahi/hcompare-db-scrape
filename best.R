...
#
# Write a funtion called best() that takes two arguments: the
# 2-character abbreviated name of a state, and an outcome name.
# The function reads outcome-of-care-measures.cvs and return a
...
# have data on a particular outcome should be excluded from the
# set of hospitals when deciding the rankings.
#
# If there is a tie for the best hospital for a given outcome,
# then the hospital names should be sorted in alphabetical
...
# passed to best(), the function should throw an error via
